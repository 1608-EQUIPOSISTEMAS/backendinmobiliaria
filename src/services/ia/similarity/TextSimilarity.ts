import { TextProcessor } from '../classification/nlp/TextProcessor';
...
export class TextSimilarity {
   ...
   */
  private createFrequencyVector(tokens: string[], allTokens: string[]): number[] {
    const vector: number[] = new Array(allTokens.length).fill(0);
